...
import {toStyleObj, withPrefix, htmlToReact, getData, markdownify} from '../utils';
              ...
              <article className="post post-full">
                ...
                <div className="inner-md outer">
                  <div className="post-content">
                    {_.get(this.props, 'page.frontmatter.previous_considerations', null) && ((() => {
                        let previous_considerations = getData(this.props.data, _.get(this.props, 'page.frontmatter.previous_considerations', null));
                        return (
                        <div className="post-meta">
                          <div><strong>Previous Considerations</strong></div>
                          {markdownify(previous_considerations.content)}
                        </div>
                        );
                    })())}
