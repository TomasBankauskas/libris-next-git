...
import {toStyleObj, withPrefix, getPages, Link, getData, markdownify} from '../utils';
              ...
              <div className="inner-md outer">
                <div className="post-feed">
                  ...
                  <article key={post_idx} className="post">
                    ...
                    {_.get(post, 'frontmatter.previous_considerations', null) && ((() => {
                        let previous_considerations = getData(this.props.data, _.get(post, 'frontmatter.previous_considerations', null));
                        return (
